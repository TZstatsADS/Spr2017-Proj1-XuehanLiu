...
AL<-sentence.list[which(sentence.list$President=="Abraham Lincoln"),13:22]
UG<-sentence.list[which(sentence.list$President=="Ulysses S. Grant"),13:22]
TR<-sentence.list[which(sentence.list$President=="Theodore Roosevelt"),13:22]
DE<-sentence.list[which(sentence.list$President=="Dwight D. Eisenhower"),13:22]
RR<-sentence.list[which(sentence.list$President=="Ronald Reagan"),13:22]
...
#Creat a subset that contains five Democratic presidents mentioned above
FiveDemo<-
