...
####Question 2: Who are typical representatives for each party by text analysis?

```{r, message=FALSE, warning=FALSE}

```

####Question 3: what sentiments they carries in their speeches?
