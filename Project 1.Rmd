...
####Question 2: for those who are considered as "best" (representative) presidents in the history, what is the difference in the speeches' sentiments/emotions for two ?
...
ggplot(data=sscore,aes(x=type,y=score,colour=party,group=President))+
  geom_point()+geom_line()+ggtitle("Figure2.Sentiment Score for Ten Presidents")+theme_bw()+labs(x="Emotions / Sentiments",y="Emotion Scores")
