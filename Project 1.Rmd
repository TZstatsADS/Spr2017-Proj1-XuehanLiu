...
#Remove words that are unuseful but maybe frequent in a inaugural speech
text<-tm_map(text, removeWords, c("a","the","people","will","government","nation","world","we","We","A","can","own", "right", "that", "their", "these", "they", "this", "which", "who", "with","have","has","not","our","been","and"))
...
textm <- DocumentTermMatrix(text)   
textm 

tdm <- TermDocumentMatrix(text)
freq <- colSums(as.matrix(textm))   
length(freq)
ordfreq <- order(freq) 
