...
In terms of comparing for Repubilican and Democratic party, for some negative emotions, such as anger and disgust, presidents from the Democratic party tend to have better control than presidents from the Repubilican party do because most blues points are below red ones in the figure. On some positive emotions such as anticipating, joy, positive, and trust, presidents from Repubilican party are also have higher scores that Democratic party presidents do. 
